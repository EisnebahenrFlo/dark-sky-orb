...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Modernes Wetter-Dashboard mit ICON-D2 Daten für Deutschland, Österreich, Schweiz und Italien." },
      { name: "author", content: "Meteo" },
      { property: "og:title", content: "MeteoFlo · Wetter für DACH & Italien" },
      { property: "og:description", content: "Modernes Wetter-Dashboard mit ICON-D2 Daten für Deutschland, Österreich, Schweiz und Italien." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "MeteoFlo · Wetter für DACH & Italien" },
      { name: "twitter:description", content: "Modernes Wetter-Dashboard mit ICON-D2 Daten für Deutschland, Österreich, Schweiz und Italien." },
